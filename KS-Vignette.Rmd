...
We can discard our D value here because it is going to compare two data sets. Since we are only working with one, a D value of 1 makes sense, since our one set is going to be 100% similar to itself.
