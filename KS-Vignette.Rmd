...
```{r 4, include=TRUE}
data_2 <- matrix(c(18, 16, 25, 18, 17, 8, 18, 11, 14, 18, 5, 13, 18, 22, 19), nrow = 2, ncol = 6)
colnames(new_data) <- c('Prediction', 'A.marmorata ','C.fimbriata ','C.picta ','C.flavomarginata ', 'C.amboinensis')
rownames(new_data) <-  c('Cucumber','Lettuce')
#assign to table
final_new = as.table(new_data)
